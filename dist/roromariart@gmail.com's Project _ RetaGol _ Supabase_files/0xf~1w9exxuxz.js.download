...
`,s=t.z.object({grantor:t.z.string(),grantee:t.z.string(),privilege_type:t.z.union([t.z.literal("SELECT"),t.z.literal("INSERT"),t.z.literal("UPDATE"),t.z.literal("REFERENCES")]),is_grantable:t.z.boolean()}),o=t.z.object({column_id:t.z.string(),relation_schema:t.z.string(),relation_name:t.z.string(),column_name:t.z.string(),privileges:t.z.array(s)}),c=t.z.array(o);t.z.object({columnId:t.z.string(),grantee:t.z.string(),privilegeType:t.z.union([t.z.literal("ALL"),t.z.literal("SELECT"),t.z.literal("INSERT"),t.z.literal("UPDATE"),t.z.literal("REFERENCES")]),isGrantable:t.z.boolean().optional()}),e.s(["default",0,{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,columnIds:s,limit:o,offset:d}={}){let _=n.safeSql`
  ...
  `,m=[],p=r(t,i,e?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return p&&m.push(n.safeSql`relation_schema ${p}`),s?.length&&m.push(n.safeSql`column_id in (${(0,n.joinSqlFragments)(s.map(n.literal),",")})`),m.length>0&&(_=n.safeSql`${_} where ${(0,n.joinSqlFragments)(m," and ")}`),o&&(_=n.safeSql`${_} limit ${(0,n.literal)(o)}`),d&&(_=n.safeSql`${_} offset ${(0,n.literal)(d)}`),{sql:_,zod:c}},grant:function(e){return{sql:n.safeSql`
do $$
declare
  col record;
begin
...
WHERE
  ...
  ${t}
`},m=_();e.s(["COLUMNS_SQL",0,m,"getColumnsSql",0,_],9172);let p=t.z.object({id:t.z.string(),table_id:t.z.number(),schema:t.z.string(),table:t.z.string(),name:t.z.string(),ordinal_position:t.z.number(),data_type:t.z.string(),format:t.z.string(),format_schema:t.z.string().optional(),is_identity:t.z.boolean(),identity_generation:t.z.string().nullable(),is_generated:t.z.boolean(),is_nullable:t.z.boolean(),is_updatable:t.z.boolean(),is_unique:t.z.boolean(),check:t.z.string().nullable(),default_value:t.z.any().nullable(),enums:t.z.array(t.z.string()),comment:t.z.string().nullable()}),u=t.z.array(p),E=t.z.optional(p);function f(e){let t=void 0!==e.schema?n.safeSql`${(0,n.ident)(e.schema)}.${(0,n.ident)(e.name)}`:(0,n.ident)(e.name);return e.isArray?n.safeSql`${t}[]`:t}e.s(["default",0,{list:function({tableId:e,includeSystemSchemas:t=!1,includedSchemas:i,excludedSchemas:l,limit:s,offset:o}={}){let c=n.safeSql`
with
  columns as (${m})
select
  *
...
where
 true
`,d=r(i,l,t?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return d&&(c=n.safeSql`${c} and schema ${d}`),void 0!==e&&(c=n.safeSql`${c} and table_id = ${(0,n.literal)(e)} `),s&&(c=n.safeSql`${c} limit ${(0,n.literal)(s)}`),o&&(c=n.safeSql`${c} offset ${(0,n.literal)(o)}`),{sql:c,zod:u}},retrieve:function(e){return{sql:n.safeSql`WITH columns AS (${m}) SELECT * FROM columns WHERE ${function(e){if("id"in e&&e.id)return n.safeSql`${(0,n.ident)("id")} = ${(0,n.literal)(e.id)}`;if("name"in e&&e.name&&e.schema&&e.table)return n.safeSql`schema = ${(0,n.literal)(e.schema)} AND ${(0,n.ident)("table")} = ${(0,n.literal)(e.table)} AND name = ${(0,n.literal)(e.name)}`;throw Error("Must provide either id or schema, name and table")}(e)};`,zod:E}},create:function({schema:e,table:t,name:a,type:i,is_identity:r=!1,identity_generation:l="BY DEFAULT",is_nullable:s,is_primary_key:o=!1,is_unique:c=!1,comment:d,check:_,no_transaction:m=!1,...p}){let u=n.safeSql``;if(r){if(void 0!==p.default_value)throw Error("Columns cannot both be identity and have a default value");u=n.safeSql`GENERATED ${(0,n.keyword)(l)} AS IDENTITY`}else void 0===p.default_value||(u="expression"===p.default_value_format?n.safeSql`DEFAULT ${p.default_value}`:n.safeSql`DEFAULT ${(0,n.literal)(p.default_value)}`);let E=void 0===s?n.safeSql``:s?n.safeSql`NULL`:n.safeSql`NOT NULL`,g=o?n.safeSql`PRIMARY KEY`:n.safeSql``,S=c?n.safeSql`UNIQUE`:n.safeSql``,b=void 0===_?n.safeSql``:n.safeSql`CHECK (${(0,n.rawSql)(_)})`,N=void 0===d?n.safeSql``:n.safeSql`COMMENT ON COLUMN ${(0,n.ident)(e)}.${(0,n.ident)(t)}.${(0,n.ident)(a)} IS ${(0,n.literal)(d)}`,h=n.safeSql`
  ALTER TABLE ${(0,n.ident)(e)}.${(0,n.ident)(t)} ADD COLUMN ${(0,n.ident)(a)} ${f(i)}
    ...
    ${S}
    ${b};
  ${N};`;return m?{sql:h}:{sql:n.safeSql`
  BEGIN;
    ${h};
  COMMIT;`}},update:function(e,{name:t,type:a,drop_default:i=!1,default_value:r,default_value_format:l="literal",is_identity:s,identity_generation:o="BY DEFAULT",is_nullable:c,is_unique:d,comment:_,check:m}){let p,u,E,g=void 0===t||t===e.name?n.safeSql``:n.safeSql`ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)} RENAME COLUMN ${(0,n.ident)(e.name)} TO ${(0,n.ident)(t)};`,S=void 0===a?n.safeSql``:n.safeSql`ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)} ALTER COLUMN ${(0,n.ident)(e.name)} SET DATA TYPE ${f(a)} USING ${(0,n.ident)(e.name)}::${f(a)};`;if(i)p=n.safeSql`ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)} ALTER COLUMN ${(0,n.ident)(e.name)} DROP DEFAULT;`;else if(void 0===r)p=n.safeSql``;else{let t="expression"===l?r:(0,n.literal)(r);p=n.safeSql`ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)} ALTER COLUMN ${(0,n.ident)(e.name)} SET DEFAULT ${t};`}let b=n.safeSql`ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)} ALTER COLUMN ${(0,n.ident)(e.name)}`;u=!1===s?n.safeSql`${b} DROP IDENTITY IF EXISTS;`:!0===e.is_identity?void 0===o?n.safeSql``:n.safeSql`${b} SET GENERATED ${(0,n.keyword)(o)};`:void 0===s?n.safeSql``:n.safeSql`${b} ADD GENERATED ${(0,n.keyword)(o)} AS IDENTITY;`,E=void 0===c?n.safeSql``:c?n.safeSql`ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)} ALTER COLUMN ${(0,n.ident)(e.name)} DROP NOT NULL;`:n.safeSql`ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)} ALTER COLUMN ${(0,n.ident)(e.name)} SET NOT NULL;`;let N=n.safeSql``;!0===e.is_unique&&!1===d?N=n.safeSql`
DO $$
DECLARE
  r record;
BEGIN
  ...
  END LOOP;
END
$$;`:!1===e.is_unique&&!0===d&&(N=n.safeSql`ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)} ADD UNIQUE (${(0,n.ident)(e.name)});`);let h=void 0===_?n.safeSql``:n.safeSql`COMMENT ON COLUMN ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)}.${(0,n.ident)(e.name)} IS ${(0,n.literal)(_)};`,T=n.safeSql``;if(void 0!==m){let t=null!==m?n.safeSql`
  ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)} ADD CONSTRAINT ${(0,n.ident)(`${e.table}_${e.name}_check`)} CHECK (${m});
  ...
  ASSERT v_conkey[1] = ${(0,n.literal)(e.ordinal_position)}, 'error creating column constraint: check condition cannot refer to other columns';`:n.safeSql``;T=n.safeSql`
DO $$
DECLARE
  v_conname name;
  v_conkey int2[];
...
BEGIN;
  ...
  ${T}
  ${g}
COMMIT;`}},remove:function(e,{cascade:t=!1}={}){return{sql:n.safeSql`ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)} DROP COLUMN ${(0,n.ident)(e.name)} ${t?n.safeSql`CASCADE`:n.safeSql`RESTRICT`};`}},zod:p},"pgColumnArrayZod",0,u],761087);let g=n.safeSql`
SELECT
  name,
  setting,
  category,
...
ORDER BY
  category,
  name
`,S=t.z.object({name:t.z.string(),setting:t.z.string(),category:t.z.string(),group:t.z.string(),subgroup:t.z.string(),unit:t.z.string().nullable(),short_desc:t.z.string(),extra_desc:t.z.string().nullable(),context:t.z.string(),vartype:t.z.string(),source:t.z.string(),min_val:t.z.string().nullable(),max_val:t.z.string().nullable(),enumvals:t.z.array(t.z.string()).nullable(),boot_val:t.z.string().nullable(),reset_val:t.z.string().nullable(),sourcefile:t.z.string().nullable(),sourceline:t.z.number().nullable(),pending_restart:t.z.boolean()}),b=t.z.array(S);e.s(["default",0,{list:function({limit:e,offset:t}={}){let a=g;return e&&(a=n.safeSql`${a} LIMIT ${(0,n.literal)(e)}`),t&&(a=n.safeSql`${a} OFFSET ${(0,n.literal)(t)}`),{sql:a,zod:b}},zod:S}],486603);let N=n.safeSql`
SELECT
  e.name,
  n.nspname AS schema,
  e.default_version,
...
`,h=t.z.object({name:t.z.string(),schema:t.z.string().nullable(),default_version:t.z.string(),installed_version:t.z.string().nullable(),comment:t.z.string()}),T=t.z.array(h),v=t.z.optional(h);e.s(["default",0,{list:function({limit:e,offset:t}={}){let a=N;return e&&(a=n.safeSql`${a} LIMIT ${(0,n.literal)(e)}`),t&&(a=n.safeSql`${a} OFFSET ${(0,n.literal)(t)}`),{sql:a,zod:T}},retrieve:function({name:e}){return{sql:n.safeSql`${N} WHERE name = ${(0,n.literal)(e)};`,zod:v}},create:function({name:e,schema:t,version:a,cascade:i=!1}){return{sql:n.safeSql`
...
where
  c.relkind = 'f'
`,$=t.z.object({id:t.z.number(),schema:t.z.string(),name:t.z.string(),comment:t.z.string().nullable(),foreign_server_name:t.z.string(),foreign_data_wrapper_name:t.z.string(),foreign_data_wrapper_handler:t.z.string(),columns:u.optional()}),I=t.z.array($),q=t.z.optional($),R=({includeColumns:e})=>n.safeSql`
with foreign_tables as (${A})
  ${e?n.safeSql`, columns as (${m})`:n.safeSql``}
select
  *
  ${e?n.safeSql`, ${i("columns",n.safeSql`columns.table_id = foreign_tables.id`)}`:n.safeSql``}
from foreign_tables`;e.s(["default",0,{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:l,offset:s,includeColumns:o=!0}={}){let c=R({includeColumns:o}),d=r(t,i,e?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return d&&(c=n.safeSql`${c} where schema ${d}`),l&&(c=n.safeSql`${c} limit ${(0,n.literal)(l)}`),s&&(c=n.safeSql`${c} offset ${(0,n.literal)(s)}`),{sql:c,zod:I}},retrieve:function(e){return{sql:n.safeSql`${R({includeColumns:!0})} where ${function(e){if("id"in e&&e.id)return n.safeSql`${(0,n.ident)("id")} = ${(0,n.literal)(e.id)}`;if("name"in e&&e.name&&e.schema)return n.safeSql`${(0,n.ident)("name")} = ${(0,n.literal)(e.name)} and ${(0,n.ident)("schema")} = ${(0,n.literal)(e.schema)}`;throw Error("Must provide either id or name and schema")}(e)};`,zod:q}},zod:$}],254873);let L=n.safeSql`
...
`,y=t.z.object({id:t.z.number(),schema:t.z.string(),name:t.z.string(),language:t.z.string(),definition:t.z.string(),complete_statement:t.z.string(),args:t.z.array(t.z.object({mode:t.z.union([t.z.literal("in"),t.z.literal("out"),t.z.literal("inout"),t.z.literal("variadic"),t.z.literal("table")]),name:t.z.string(),type_id:t.z.number(),has_default:t.z.boolean()})),argument_types:t.z.string(),identity_argument_types:t.z.string(),return_type_id:t.z.number(),return_type:t.z.string(),return_type_relation_id:t.z.union([t.z.number(),t.z.null()]),is_set_returning_function:t.z.boolean(),behavior:t.z.union([t.z.literal("IMMUTABLE"),t.z.literal("STABLE"),t.z.literal("VOLATILE")]),security_definer:t.z.boolean(),config_params:t.z.union([t.z.record(t.z.string(),t.z.string()),t.z.null()])}),O=t.z.array(y),C=t.z.optional(y),F=t.z.object({name:t.z.string(),definition:t.z.string(),args:t.z.array(t.z.string()).optional(),behavior:t.z.enum(["IMMUTABLE","STABLE","VOLATILE"]).optional(),config_params:t.z.record(t.z.string(),t.z.string()).optional(),schema:t.z.string().optional(),language:t.z.string().optional(),return_type:t.z.string().optional(),security_definer:t.z.boolean().optional()});function D(e){return e.split(".").map(n.ident).reduce((e,t,a)=>0===a?t:n.safeSql`${e}.${t}`,n.safeSql``)}function z({name:e,schema:t,args:a,definition:i,return_type:r,language:l,behavior:s,security_definer:o,config_params:c},{replace:d=!1}={}){let _=a&&a.length>0?(0,n.joinSqlFragments)(a,", "):n.safeSql``,m=c&&Object.keys(c).length>0?(0,n.joinSqlFragments)(Object.entries(c).map(([e,t])=>"FROM CURRENT"===t?n.safeSql`SET ${D(e)} FROM CURRENT`:n.safeSql`SET ${D(e)} TO ${t}`),"\n"):n.safeSql``;return n.safeSql`
    CREATE ${d?n.safeSql`OR REPLACE`:n.safeSql``} FUNCTION ${(0,n.ident)(t)}.${(0,n.ident)(e)}(${_})
    RETURNS ${r}
    AS ${(0,n.literal)(i)}
    ...
    ${m};
  `}let w=t.z.object({name:t.z.string().optional(),schema:t.z.string().optional(),definition:t.z.string().optional()}),x=t.z.object({cascade:t.z.boolean().default(!1).optional()});e.s(["create",0,function({name:e,schema:a="public",args:i=[],definition:r,return_type:l=n.safeSql`void`,language:s="sql",behavior:o="VOLATILE",security_definer:c=!1,config_params:d={}}){return{sql:z({name:e,schema:a,args:i,definition:r,return_type:l,language:s,behavior:o,security_definer:c,config_params:d}),zod:t.z.void()}},"list",0,function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:l,offset:s}={}){let o=n.safeSql`
    with f as (
      ${L}
    )
    select
      f.*
    from f
  `,c=r(t,i,e?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return c&&(o=n.safeSql`${o} where schema ${c}`),l&&(o=n.safeSql`${o} limit ${(0,n.literal)(l)}`),s&&(o=n.safeSql`${o} offset ${(0,n.literal)(s)}`),{sql:o,zod:O}},"pgFunctionArrayZod",0,O,"pgFunctionCreateZod",0,F,"pgFunctionDeleteZod",0,x,"pgFunctionOptionalZod",0,C,"pgFunctionUpdateZod",0,w,"pgFunctionZod",0,y,"remove",0,function(e,{cascade:a=!1}={}){return{sql:n.safeSql`DROP FUNCTION ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.name)}(${e.identity_argument_types}) ${a?n.safeSql`CASCADE`:n.safeSql`RESTRICT`};`,zod:t.z.void()}},"retrieve",0,function({id:e,name:t,schema:a="public",args:i=[]}){if(e)return{sql:n.safeSql`
      with f as (
        ${L}
      )
      select
        f.*
      from f where id = ${(0,n.literal)(e)};`,zod:C};if(t&&a&&i){let e=i.length?n.safeSql`(
    ...
    select
      f.*
    from f join pg_proc as p on id = p.oid where schema = ${(0,n.literal)(a)} and name = ${(0,n.literal)(t)} and p.proargtypes::text = ${e}`,zod:C}}throw Error("Must provide either id or name and schema")},"update",0,function(e,{name:a,schema:i,definition:r}){let l=e.argument_types.split(", "),s=e.identity_argument_types,o="string"==typeof r?z({...e,definition:r,args:l,config_params:e.config_params??{}},{replace:!0}):n.safeSql``,c=a&&a!==e.name?n.safeSql`ALTER FUNCTION ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.name)}(${s}) RENAME TO ${(0,n.ident)(a)};`:n.safeSql``,d=i&&i!==e.schema?n.safeSql`ALTER FUNCTION ${(0,n.ident)(e.schema)}.${(0,n.ident)(a||e.name)}(${s}) SET SCHEMA ${(0,n.ident)(i)};`:n.safeSql``;return{sql:n.safeSql`
    DO LANGUAGE plpgsql $$
    BEGIN
    ...
    END;
    $$;
  `,zod:t.z.void()}}],198687);let U=n.safeSql`
  SELECT
...
where
  c.relkind = 'm'
`,P=t.z.object({id:t.z.number(),schema:t.z.string(),name:t.z.string(),is_populated:t.z.boolean(),comment:t.z.string().nullable(),columns:u.optional()}),G=t.z.array(P),W=t.z.optional(P),Y=({includeColumns:e})=>n.safeSql`
with materialized_views as (${j})
  ${e?n.safeSql`, columns as (${m})`:n.safeSql``}
select
  *
  ${e?n.safeSql`, ${i("columns",n.safeSql`columns.table_id = materialized_views.id`)}`:n.safeSql``}
from materialized_views`;e.s(["default",0,{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:l,offset:s,includeColumns:o=!0}={}){let c=Y({includeColumns:o}),d=r(t,i,e?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return d&&(c=n.safeSql`${c} where schema ${d}`),l&&(c=n.safeSql`${c} limit ${(0,n.literal)(l)}`),s&&(c=n.safeSql`${c} offset ${(0,n.literal)(s)}`),{sql:c,zod:G}},retrieve:function(e){let t=function(e){if("id"in e&&e.id)return n.safeSql`${(0,n.ident)("id")} = ${(0,n.literal)(e.id)}`;if("name"in e&&e.name&&e.schema)return n.safeSql`${(0,n.ident)("name")} = ${(0,n.literal)(e.name)} and ${(0,n.ident)("schema")} = ${(0,n.literal)(e.schema)}`;throw Error("Must provide either id or name and schema")}(e);return{sql:n.safeSql`${Y({includeColumns:!0})} where ${t};`,zod:W}},zod:P}],784883);let B=n.safeSql`
select
  pol.oid :: int8 as id,
  n.nspname as schema,
  c.relname as table,
...
`,X=t.z.object({id:t.z.number(),schema:t.z.string(),table:t.z.string(),table_id:t.z.number(),name:t.z.string(),action:t.z.union([t.z.literal("PERMISSIVE"),t.z.literal("RESTRICTIVE")]),roles:t.z.array(t.z.string()),command:t.z.union([t.z.literal("SELECT"),t.z.literal("INSERT"),t.z.literal("UPDATE"),t.z.literal("DELETE"),t.z.literal("ALL")]),definition:t.z.union([t.z.string(),t.z.null()]),check:t.z.union([t.z.string(),t.z.null()])}),J=t.z.array(X),Q=t.z.optional(X);e.s(["default",0,{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:l,offset:s}={}){let o=n.safeSql`
    with policies as (${B})
    select *
    from policies
    `,c=r(t,i,e?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return c&&(o=n.safeSql`${o}where schema ${c}`),l&&(o=n.safeSql`${o} limit ${(0,n.literal)(l)}`),s&&(o=n.safeSql`${o} offset ${(0,n.literal)(s)}`),{sql:o,zod:J}},retrieve:function(e){return{sql:n.safeSql`with policies as (${B}) select * from policies where ${function(e){if("id"in e&&e.id)return n.safeSql`id = ${(0,n.literal)(e.id)}`;if("name"in e&&e.name&&e.schema&&e.table)return n.safeSql`name = ${(0,n.literal)(e.name)} AND schema = ${(0,n.literal)(e.schema)} AND table = ${(0,n.literal)(e.table)}`;throw Error("Must provide either id or name, schema and table")}(e)};`,zod:Q}},create:function({name:e,schema:t="public",table:a,definition:i,check:r,action:l="PERMISSIVE",command:s="ALL",roles:o=["public"]}){let c=(0,n.joinSqlFragments)(o.map(n.ident),", "),d=i?n.safeSql`using (${i})`:n.safeSql``,_=r?n.safeSql`with check (${r})`:n.safeSql``;return{sql:n.safeSql`
create policy ${(0,n.ident)(e)} on ${(0,n.ident)(t)}.${(0,n.ident)(a)}
  as ${(0,n.keyword)(l)}
  for ${(0,n.keyword)(s)}
  to ${c}
  ${d}
  ${_};`}},update:function(e,t){let{name:a,definition:i,check:r,roles:l}=t,s=n.safeSql`ALTER POLICY ${(0,n.ident)(e.name)} ON ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)}`,o=void 0===a?n.safeSql``:n.safeSql`${s} RENAME TO ${(0,n.ident)(a)};`,c=void 0===i?n.safeSql``:n.safeSql`${s} USING (${i});`,d=void 0===r?n.safeSql``:n.safeSql`${s} WITH CHECK (${r});`,_=void 0===l?n.safeSql``:n.safeSql`${s} TO ${(0,n.joinSqlFragments)(l.map(n.ident),", ")};`;return{sql:n.safeSql`BEGIN; ${c} ${d} ${_} ${o} COMMIT;`}},remove:function(e){return{sql:n.safeSql`DROP POLICY ${(0,n.ident)(e.name)} ON ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)};`}},zod:X}],201049);let V=n.safeSql`
SELECT
  p.oid :: int8 AS id,
  p.pubname AS name,
...
`,K=t.z.object({id:t.z.number().optional(),name:t.z.string(),schema:t.z.string()}),Z=t.z.object({id:t.z.number(),name:t.z.string(),owner:t.z.string(),publish_insert:t.z.boolean(),publish_update:t.z.boolean(),publish_delete:t.z.boolean(),publish_truncate:t.z.boolean(),tables:t.z.array(K).nullable()}),ee=t.z.array(Z),et=t.z.optional(Z);e.s(["default",0,{list:function({limit:e,offset:t}={}){let a=n.safeSql`with publications as (${V}) select * from publications`;return e&&(a=n.safeSql`${a} limit ${(0,n.literal)(e)}`),t&&(a=n.safeSql`${a} offset ${(0,n.literal)(t)}`),{sql:a,zod:ee}},retrieve:function(e){return{sql:n.safeSql`with publications as (${V}) select * from publications where ${function(e){if("id"in e&&e.id)return n.safeSql`${(0,n.ident)("id")} = ${(0,n.literal)(e.id)}`;if("name"in e&&e.name)return n.safeSql`${(0,n.ident)("name")} = ${(0,n.literal)(e.name)}`;throw Error("Must provide either id or name")}(e)};`,zod:et}},create:function({name:e,publish_insert:t=!1,publish_update:a=!1,publish_delete:i=!1,publish_truncate:r=!1,tables:l=null}){let s;s=null==l?n.safeSql`FOR ALL TABLES`:0===l.length?n.safeSql``:n.safeSql`FOR TABLE ${(0,n.joinSqlFragments)(l.map(e=>{if(!e.includes("."))return(0,n.ident)(e);let[t,...a]=e.split("."),i=a.join(".");return n.safeSql`${(0,n.ident)(t)}.${(0,n.ident)(i)}`}),",")}`;let o=[];return t&&o.push("insert"),a&&o.push("update"),i&&o.push("delete"),r&&o.push("truncate"),{sql:n.safeSql`
...
`}},remove:function(e){return{sql:n.safeSql`DROP PUBLICATION IF EXISTS ${(0,n.ident)(e.name)};`}},zod:Z}],557928);let ea=n.safeSql`
...
`,en=t.z.object({id:t.z.number(),name:t.z.string(),isSuperuser:t.z.boolean(),canCreateDb:t.z.boolean(),canCreateRole:t.z.boolean(),inheritRole:t.z.boolean(),canLogin:t.z.boolean(),isReplicationRole:t.z.boolean(),canBypassRls:t.z.boolean(),activeConnections:t.z.number(),connectionLimit:t.z.number(),validUntil:t.z.union([t.z.string(),t.z.null()]),config:t.z.record(t.z.string(),t.z.string())}),ei=t.z.array(en),er=t.z.optional(en);function el(e){if("id"in e&&e.id)return n.safeSql`${(0,n.ident)("id")} = ${(0,n.literal)(e.id)}`;if("name"in e&&e.name)return n.safeSql`${(0,n.ident)("name")} = ${(0,n.literal)(e.name)}`;throw Error("Must provide either id or name")}e.s(["default",0,{list:function({includeDefaultRoles:e=!1,limit:t,offset:a}={}){let i=n.safeSql`
with
  roles as (${ea})
select
  *
...
where
  true
`;return e||(i=n.safeSql`${i} and not pg_catalog.starts_with(name, 'pg_')`),t&&(i=n.safeSql`${i} limit ${(0,n.literal)(t)}`),a&&(i=n.safeSql`${i} offset ${(0,n.literal)(a)}`),{sql:i,zod:ei}},retrieve:function(e){return{sql:n.safeSql`with roles as (${ea}) select * from roles where ${el(e)};`,zod:er}},create:function({name:e,isSuperuser:t=!1,canCreateDb:a=!1,canCreateRole:i=!1,inheritRole:r=!0,canLogin:l=!1,isReplicationRole:s=!1,canBypassRls:o=!1,connectionLimit:c=-1,password:d,validUntil:_,memberOf:m=[],members:p=[],admins:u=[],config:E={}}){return{sql:n.safeSql`
create role ${(0,n.ident)(e)}
  ...
  ${0===m.length?n.safeSql``:n.safeSql`in role ${(0,n.joinSqlFragments)(m.map(n.ident),",")}`}
  ${0===p.length?n.safeSql``:n.safeSql`role ${(0,n.joinSqlFragments)(p.map(n.ident),",")}`}
...
`}},update:function(e,t){let{name:a,isSuperuser:i,canCreateDb:r,canCreateRole:l,inheritRole:s,canLogin:o,isReplicationRole:c,canBypassRls:d,connectionLimit:_,password:m,validUntil:p}=t;return{sql:n.safeSql`
do $$
declare
  old record;
begin
  with roles as (${ea})
  select * into old from roles where ${el(e)};
  if old is null then
  ...
  execute(format('alter role %I
    ...
    ${void 0===m?n.safeSql``:n.safeSql`password ${(0,n.literal)(m)}`}
    ${void 0===p?n.safeSql``:n.safeSql`valid until %L`}
  ', old.name${void 0===p?n.safeSql``:n.safeSql`, ${(0,n.literal)(p)}`}));
...
$$;
`}},zod:en}],567205);let es=n.safeSql`
...
`,eo=t.z.object({id:t.z.number(),name:t.z.string(),owner:t.z.string(),comment:t.z.string().nullable()}),ec=t.z.array(eo),ed=t.z.optional(eo);e.s(["default",0,{list:function({includeSystemSchemas:e=!1,limit:t,offset:i}={}){let r=es;return e||(r=n.safeSql`${r} and not (n.nspname in (${(0,n.joinSqlFragments)(a.DEFAULT_SYSTEM_SCHEMAS.map(n.literal),",")}))`),t&&(r=n.safeSql`${r} limit ${(0,n.literal)(t)}`),i&&(r=n.safeSql`${r} offset ${(0,n.literal)(i)}`),{sql:r,zod:ec}},retrieve:function({id:e,name:t}){return e?{sql:n.safeSql`${es} and n.oid = ${(0,n.literal)(e)};`,zod:ed}:{sql:n.safeSql`${es} and n.nspname = ${(0,n.literal)(t)};`,zod:ed}},create:function({name:e,owner:t}){return{sql:n.safeSql`create schema ${(0,n.ident)(e)}
...
$$;
`}},zod:eo}],912920);let e_=n.safeSql`
...
group by
  ...
  c.relname,
  c.relkind
`,em=t.z.object({relation_id:t.z.number(),schema:t.z.string(),name:t.z.string(),kind:t.z.union([t.z.literal("table"),t.z.literal("view"),t.z.literal("materialized_view"),t.z.literal("foreign_table"),t.z.literal("partitioned_table")]),privileges:t.z.array(t.z.object({grantor:t.z.string(),grantee:t.z.string(),privilege_type:t.z.union([t.z.literal("SELECT"),t.z.literal("INSERT"),t.z.literal("UPDATE"),t.z.literal("DELETE"),t.z.literal("TRUNCATE"),t.z.literal("REFERENCES"),t.z.literal("TRIGGER"),t.z.literal("MAINTAIN")]),is_grantable:t.z.boolean()}))}),ep=t.z.array(em),eu=t.z.optional(em);e.s(["default",0,{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:l,offset:s}={}){let o=n.safeSql`
with table_privileges as (${e_})
select *
from table_privileges
`,c=r(t,i,e?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return c&&(o=n.safeSql`${o} where schema ${c}`),l&&(o=n.safeSql`${o} limit ${(0,n.literal)(l)}`),s&&(o=n.safeSql`${o} offset ${(0,n.literal)(s)}`),{sql:o,zod:ep}},retrieve:function({id:e,name:t,schema:a="public"}){return e?{sql:n.safeSql`
with table_privileges as (${e_})
select *
from table_privileges
where table_privileges.relation_id = ${(0,n.literal)(e)};`,zod:eu}:{sql:n.safeSql`
with table_privileges as (${e_})
select *
from table_privileges
where table_privileges.schema = ${(0,n.literal)(a)}
  and table_privileges.name = ${(0,n.literal)(t)}
`,zod:eu}},grant:function(e){return{sql:n.safeSql`
do $$
begin
...
`}},zod:em}],454430);let eE=n.safeSql`
SELECT
  c.oid :: int8 AS id,
  nc.nspname AS schema,
  c.relname AS name,
...
group by
  ...
  nc.nspname,
  pk.primary_keys
`,ef=t.z.object({table_id:t.z.number(),name:t.z.string(),schema:t.z.string(),table_name:t.z.string()}),eg=t.z.object({id:t.z.number(),constraint_name:t.z.string(),source_schema:t.z.string(),source_table_name:t.z.string(),source_column_name:t.z.string(),target_table_schema:t.z.string(),target_table_name:t.z.string(),target_column_name:t.z.string()}),eS=t.z.object({id:t.z.number(),schema:t.z.string(),name:t.z.string(),rls_enabled:t.z.boolean(),rls_forced:t.z.boolean(),replica_identity:t.z.enum(["DEFAULT","INDEX","FULL","NOTHING"]),bytes:t.z.number(),size:t.z.string(),live_rows_estimate:t.z.number(),dead_rows_estimate:t.z.number(),comment:t.z.string().nullable(),primary_keys:t.z.array(ef),relationships:t.z.array(eg),columns:u.optional()}),eb=t.z.array(eS),eN=({includeColumns:e})=>n.safeSql`
  with tables as (${eE})
  ${e?n.safeSql`, columns as (${m})`:n.safeSql``}
  select
    *
    ${e?n.safeSql`, ${i("columns",n.safeSql`columns.table_id = tables.id`)}`:n.safeSql``}
  from tables`;e.s(["create",0,function({name:e,schema:t="public",comment:a,no_transaction:i=!1}){let r=n.safeSql`CREATE TABLE ${(0,n.ident)(t)}.${(0,n.ident)(e)} ();`,l=void 0!=a?n.safeSql`COMMENT ON TABLE ${(0,n.ident)(t)}.${(0,n.ident)(e)} IS ${(0,n.literal)(a)};`:n.safeSql``;return i?{sql:n.safeSql`${r} ${l}`}:{sql:n.safeSql`BEGIN; ${r} ${l} COMMIT;`}},"list",0,function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:l,offset:s,includeColumns:o=!0}={}){let c=eN({includeColumns:o}),d=r(t,i,e?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return d&&(c=n.safeSql`${c} where schema ${d}`),l&&(c=n.safeSql`${c} limit ${(0,n.literal)(l)}`),s&&(c=n.safeSql`${c} offset ${(0,n.literal)(s)}`),{sql:c,zod:eb}},"remove",0,function(e,{cascade:t=!1}={}){return{sql:n.safeSql`DROP TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.name)} ${t?n.safeSql`CASCADE`:n.safeSql`RESTRICT`};`}},"retrieve",0,function(e){let t=function(e){if("id"in e&&e.id)return n.safeSql`${(0,n.ident)("id")} = ${(0,n.literal)(e.id)}`;if("name"in e&&e.name&&e.schema)return n.safeSql`${(0,n.ident)("name")} = ${(0,n.literal)(e.name)} and ${(0,n.ident)("schema")} = ${(0,n.literal)(e.schema)}`;throw Error("Must provide either id or name and schema")}(e);return{sql:n.safeSql`${eN({includeColumns:!0})} where ${t};`,zod:eS}},"update",0,function(e,{name:t,schema:a,rls_enabled:i,rls_forced:r,replica_identity:l,replica_identity_index:s,primary_keys:o,comment:c}){let d=n.safeSql`ALTER TABLE ${(0,n.ident)(e.schema)}.${(0,n.ident)(e.name)}`,_=void 0===a?n.safeSql``:n.safeSql`${d} SET SCHEMA ${(0,n.ident)(a)};`,m=n.safeSql``;if(void 0!==t&&t!==e.name){let i=void 0===a?e.schema:a;m=n.safeSql`ALTER TABLE ${(0,n.ident)(i)}.${(0,n.ident)(e.name)} RENAME TO ${(0,n.ident)(t)};`}let p=n.safeSql``;if(void 0!==i){let e=n.safeSql`${d} ENABLE ROW LEVEL SECURITY;`,t=n.safeSql`${d} DISABLE ROW LEVEL SECURITY;`;p=i?e:t}let u=n.safeSql``;if(void 0!==r){let e=n.safeSql`${d} FORCE ROW LEVEL SECURITY;`,t=n.safeSql`${d} NO FORCE ROW LEVEL SECURITY;`;u=r?e:t}let E=n.safeSql``;if(void 0===l);else if("INDEX"===l){if(!s)throw Error("replica_identity_index is required when replica_identity is INDEX");E=n.safeSql`${d} REPLICA IDENTITY USING INDEX ${(0,n.ident)(s)};`}else E=n.safeSql`${d} REPLICA IDENTITY ${(0,n.keyword)(l)};`;let f=n.safeSql``;void 0===o||(f=n.safeSql`${f}
DO $$
DECLARE
  r record;
BEGIN
...
BEGIN;
  ...
  ${_}
  ${m}
COMMIT;`}}],303119);let eh=n.safeSql`
SELECT
  pg_t.oid AS id,
...
GROUP BY
  ...
  pg_p.proname,
  pg_n.nspname
`,eT=t.z.object({id:t.z.number(),table_id:t.z.number(),enabled_mode:t.z.enum(["DISABLED","ORIGIN","REPLICA","ALWAYS"]),function_args:t.z.array(t.z.string()),name:t.z.string(),table:t.z.string(),schema:t.z.string(),condition:t.z.string().nullable(),orientation:t.z.enum(["ROW","STATEMENT"]),activation:t.z.enum(["BEFORE","AFTER","INSTEAD OF"]),events:t.z.array(t.z.string()),function_name:t.z.string(),function_schema:t.z.string()}),ev=t.z.array(eT),eA=t.z.optional(eT);t.z.object({name:t.z.string(),schema:t.z.string().optional().default("public"),table:t.z.string(),function_schema:t.z.string().optional().default("public"),function_name:t.z.string(),function_args:t.z.array(t.z.string()).optional(),activation:t.z.enum(["BEFORE","AFTER","INSTEAD OF"]),events:t.z.array(t.z.string()),orientation:t.z.enum(["ROW","STATEMENT"]).optional(),condition:t.z.string().optional()}),t.z.object({name:t.z.string().optional(),enabled_mode:t.z.enum(["ORIGIN","REPLICA","ALWAYS","DISABLED"]).optional()}),e.s(["default",0,{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:l,offset:s}={}){let o=n.safeSql`with triggers as (${eh}) select * from triggers`,c=r(t,i,e?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return c&&(o=n.safeSql`${o} where schema ${c}`),l&&(o=n.safeSql`${o} limit ${(0,n.literal)(l)}`),s&&(o=n.safeSql`${o} offset ${(0,n.literal)(s)}`),{sql:o,zod:ev}},retrieve:function(e){let t=function(e){if("id"in e&&e.id)return n.safeSql`${(0,n.ident)("id")} = ${(0,n.literal)(e.id)}`;if("name"in e&&e.name&&e.table&&e.schema)return n.safeSql`${(0,n.ident)("name")} = ${(0,n.literal)(e.name)} and ${(0,n.ident)("schema")} = ${(0,n.literal)(e.schema)} and ${(0,n.ident)("table")} = ${(0,n.literal)(e.table)}`;throw Error("Must provide either id or name, schema and table")}(e);return{sql:n.safeSql`with triggers as (${eh}) select * from triggers where ${t};`,zod:eA}},create:function({name:e,schema:a="public",table:i,function_schema:r="public",function_name:l,function_args:s=[],activation:o,events:c,orientation:d,condition:_}){let m=n.safeSql`${(0,n.ident)(a)}.${(0,n.ident)(i)}`,p=n.safeSql`${(0,n.ident)(r)}.${(0,n.ident)(l)}`,u=(0,n.joinSqlFragments)(c.map(n.keyword)," or "),E=d?n.safeSql`for each ${(0,n.keyword)(d)}`:n.safeSql``,f=_?n.safeSql`when (${_})`:n.safeSql``,g=s.length>0?(0,n.joinSqlFragments)(s.map(n.literal),","):n.safeSql``;return{sql:n.safeSql`create trigger ${(0,n.ident)(e)} ${(0,n.keyword)(o)} ${u} on ${m} ${E} ${f} execute function ${p}(${g});`,zod:t.z.void()}},update:function(e,a){let i=n.safeSql`${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)}`,r=n.safeSql``;switch(a.enabled_mode){case"ORIGIN":r=n.safeSql`alter table ${i} enable trigger ${(0,n.ident)(e.name)};`;break;case"DISABLED":r=n.safeSql`alter table ${i} disable trigger ${(0,n.ident)(e.name)};`;break;case"REPLICA":case"ALWAYS":r=n.safeSql`alter table ${i} enable ${(0,n.keyword)(a.enabled_mode)} trigger ${(0,n.ident)(e.name)};`}let l=a.name&&a.name!==e.name?n.safeSql`alter trigger ${(0,n.ident)(e.name)} on ${i} rename to ${(0,n.ident)(a.name)};`:n.safeSql``;return{sql:n.safeSql`begin; ${r}; ${l}; commit;`,zod:t.z.void()}},remove:function(e,{cascade:a=!1}={}){let i=n.safeSql`${(0,n.ident)(e.schema)}.${(0,n.ident)(e.table)}`;return{sql:n.safeSql`drop trigger ${(0,n.ident)(e.name)} on ${i} ${a?n.safeSql`cascade`:n.safeSql``};`,zod:t.z.void()}},zod:eT}],819615);let e$=n.safeSql`
select
  t.oid::int8 as id,
  t.typname as name,
  n.nspname as schema,
...
`,eI=t.z.object({id:t.z.number(),name:t.z.string(),schema:t.z.string(),format:t.z.string(),enums:t.z.array(t.z.string()),attributes:t.z.array(t.z.object({name:t.z.string(),type_id:t.z.number()})),comment:t.z.string().nullable()}),eq=t.z.array(eI);e.s(["default",0,{list:function({includeArrayTypes:e=!1,includeSystemSchemas:t=!1,includedSchemas:i,excludedSchemas:l,limit:s,offset:o}={}){let c=e$;e||(c=n.safeSql`${c} and not exists (
      select from pg_type el
      where el.oid = t.typelem
        and el.typarray = t.oid
    )`);let d=r(i,l,t?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return d&&(c=n.safeSql`${c} and n.nspname ${d}`),s&&(c=n.safeSql`${c} limit ${(0,n.literal)(s)}`),o&&(c=n.safeSql`${c} offset ${(0,n.literal)(o)}`),{sql:c,zod:eq}},zod:eI}],211309);let eR=n.safeSql`
select
  version(),
...
`,eL=t.z.object({version:t.z.string(),version_number:t.z.number(),active_connections:t.z.number(),max_connections:t.z.number()});e.s(["default",0,{retrieve:function(){return{sql:eR,zod:eL}},zod:eL}],267655);let ey=n.safeSql`
SELECT
  c.oid :: int8 AS id,
  n.nspname AS schema,
  c.relname AS name,
...
from views`;e.s(["default",0,{list:function({includeSystemSchemas:e=!1,includedSchemas:t,excludedSchemas:i,limit:l,offset:s,includeColumns:o=!0}={}){let c=eD({includeColumns:o}),d=r(t,i,e?void 0:a.DEFAULT_SYSTEM_SCHEMAS);return d&&(c=n.safeSql`${c} where schema ${d}`),l&&(c=n.safeSql`${c} limit ${(0,n.literal)(l)}`),s&&(c=n.safeSql`${c} offset ${(0,n.literal)(s)}`),{sql:c,zod:eC}},retrieve:function(e){let t=function(e){if("id"in e&&e.id)return n.safeSql`${(0,n.ident)("id")} = ${(0,n.literal)(e.id)}`;if("name"in e&&e.name&&e.schema)return n.safeSql`${(0,n.ident)("name")} = ${(0,n.literal)(e.name)} and ${(0,n.ident)("schema")} = ${(0,n.literal)(e.schema)}`;throw Error("Must provide either id or name and schema")}(e);return{sql:n.safeSql`${eD({includeColumns:!0})} where ${t};`,zod:eF}},zod:eO}],58347),e.s([],967533)},721490,332357,29659,193767,212695,e=>{"use strict";var t=e.i(479084);function a(e,a){let n=t.safeSql`select count(*) from ${d(e)}`,{filters:i}=a??{};return i&&(n=o(n,i)),t.safeSql`${n};`}function n(e,a){let n=t.safeSql`truncate ${d(e)}`,{cascade:i}=a??{};return i&&(n=t.safeSql`${n} cascade`),t.safeSql`${n};`}function i(e,a,n){if(!a||0===a.length)throw Error("no filters for this delete query");let i=t.safeSql`delete from ${d(e)}`,{returning:r,enumArrayColumns:l}=n??{};if(a&&(i=o(i,a)),r){let e=void 0===l||0===l.length?t.safeSql` returning *`:t.safeSql` returning *, ${(0,t.joinSqlFragments)(l.map(e=>t.safeSql`${(0,t.ident)(e)}::text[]`),",")}`;i=t.safeSql`${i}${e}`}return t.safeSql`${i};`}function r(e,a,n){if(!a||0===a.length)throw Error("no value to insert");let{returning:i,enumArrayColumns:r}=n??{},l=(0,t.joinSqlFragments)(Object.keys(a[0]).map(e=>(0,t.ident)(e)),","),s=t.safeSql``;if(s=0==l.length?(0,t.format)(t.safeSql`insert into %1$s select from jsonb_populate_recordset(null::%1$s, %2$s)`,d(e),(0,t.literal)(JSON.stringify(a))):(0,t.format)(t.safeSql`insert into %1$s (%2$s) select %2$s from jsonb_populate_recordset(null::%1$s, %3$s)`,d(e),l,(0,t.literal)(JSON.stringify(a))),i){let e=void 0===r||0===r.length?t.safeSql` returning *`:t.safeSql` returning *, ${(0,t.joinSqlFragments)(r.map(e=>t.safeSql`${(0,t.ident)(e)}::text[]`),",")}`;s=t.safeSql`${s}${e}`}return t.safeSql`${s};`}function l(e,a,n,i=!0,r=!1){var s,c;let _,m=t.safeSql``,p=a??t.safeSql`*`;m=t.safeSql`select ${p} from ${r?(s=e,t.safeSql`${(0,t.ident)(s.name)}`):d(e)}`;let{filters:u,pagination:E,sorts:f}=n??{};if(u&&(m=o(m,u)),f&&(c=m,m=0===(_=f.filter(e=>e.column)).length?c:c=t.safeSql`${c} order by ${(0,t.joinSqlFragments)(_.map(e=>{let a=e.ascending?t.safeSql`asc`:t.safeSql`desc`,n=e.nullsFirst?t.safeSql`nulls first`:t.safeSql`nulls last`;return t.safeSql`${(0,t.ident)(e.table)}.${(0,t.ident)(e.column)} ${a} ${n}`}),", ")}`),E){let{limit:e,offset:a}=E??{};m=t.safeSql`${m} limit ${(0,t.literal)(e)} offset ${(0,t.literal)(a)}`}return t.safeSql`${m}${i?t.safeSql`;`:t.safeSql``}`}function s(e,a,n){let{filters:i,returning:r,enumArrayColumns:l}=n??{};if(!i||0===i.length)throw Error("no filters for this update query");let s=(0,t.joinSqlFragments)(Object.keys(a).map(e=>(0,t.ident)(e)),","),c=(0,t.format)(t.safeSql`update %1$s set (%2$s) = (select %2$s from json_populate_record(null::%1$s, %3$s))`,d(e),s,(0,t.literal)(JSON.stringify(a)));if(i&&(c=o(c,i)),r){let e=void 0===l||0===l.length?t.safeSql` returning *`:t.safeSql` returning *, ${(0,t.joinSqlFragments)(l.map(e=>t.safeSql`${(0,t.ident)(e)}::text[]`),",")}`;c=t.safeSql`${c}${e}`}return t.safeSql`${c};`}function o(e,a){return 0===a.length?e:e=t.safeSql`${e} where ${(0,t.joinSqlFragments)(a.map(e=>{if(Array.isArray(e.column))switch(e.operator){case"in":var a,n,i=e;if(!Array.isArray(i.column))throw Error("Use inFilterSql for single columns");if(!Array.isArray(i.value))throw Error("Values for a tuple 'in' filter must be an array");let r=t.safeSql`(${(0,t.joinSqlFragments)(i.column.map(e=>(0,t.ident)(e)),", ")})`,l=i.value.map(e=>{if(Array.isArray(e)){if(e.length!==i.column.length)throw Error("Tuple value length must match column length");return t.safeSql`(${(0,t.joinSqlFragments)(e.map(e=>c(e)),", ")})`}{let a=String(e).split(",");if(a.length!==i.column.length)throw Error("Tuple value length must match column length");return t.safeSql`(${(0,t.joinSqlFragments)(a.map(e=>c(e)),", ")})`}});return t.safeSql`${r} ${i.operator} (${(0,t.joinSqlFragments)(l,", ")})`;case"=":case"<>":case">":case"<":case">=":case"<=":var s=e;if(!Array.isArray(s.column))throw Error("Use standard applyFilters for single column");if(!Array.isArray(s.value))throw Error("Tuple filter value must be an array");if(s.value.length!==s.column.length)throw Error("Tuple filter value must have the same length as the column array");let o=t.safeSql`(${(0,t.joinSqlFragments)(s.column.map(e=>(0,t.ident)(e)),", ")})`,d=t.safeSql`(${(0,t.joinSqlFragments)(s.value.map(e=>c(e)),", ")})`;return t.safeSql`${o} ${s.operator} ${d}`;default:throw Error(`Cannot use ${e.operator} operator in a tuple filter`)}switch(e.operator){case"in":let _;return _=Array.isArray((a=e).value)?a.value.map(e=>c(e)):String(a.value).split(",").map(e=>c(e)),t.safeSql`${(0,t.ident)(a.column)} ${a.operator} (${(0,t.joinSqlFragments)(_,",")})`;case"is":var m=e;let p=String(m.value);switch(p){case"null":case"false":case"true":case"not null":return t.safeSql`${(0,t.ident)(m.column)} ${m.operator} ${p}`;default:return t.safeSql`${(0,t.ident)(m.column)} ${m.operator} ${c(m.value)}`}case"~~":case"~~*":case"!~~":case"!~~*":return n=e,t.safeSql`${(0,t.ident)(n.column)}::text ${n.operator} ${c(n.value)}`;default:return t.safeSql`${(0,t.ident)(e.column)} ${e.operator} ${c(e.value)}`}})," and ")}`}function c(e){if("boolean"==typeof e)return e?"true":"false";if("string"==typeof e&&e.startsWith("ARRAY[")){let a=function(e){if(!e.startsWith("ARRAY["))return null;let a=e.slice(6),n=!1,i=-1;for(let e=0;e<a.length;e++){let t=a[e];if(n)"'"===t&&"'"===a[e+1]?e++:"'"===t&&(n=!1);else if("]"===t){i=e;break}else"'"===t&&(n=!0)}if(-1===i)return null;let r=a.slice(0,i),l=a.slice(i+1),s=t.safeSql``;if(""!==l){let e=l.match(/^::([A-Za-z_][A-Za-z0-9_]*)(\[\])?$/);if(!e)return null;s=t.safeSql`::${e[1]}${e[2]?t.safeSql`[]`:t.safeSql``}`}let o=[],c="",d=!1;for(let e=0;e<r.length;e++){let t=r[e];d?"'"===t&&"'"===r[e+1]?(c+="''",e++):"'"===t?(c+=t,d=!1):c+=t:"'"===t?(d=!0,c+=t):","===t?(o.push(c.trim()),c=""):c+=t}c.trim()&&o.push(c.trim());let _=o.map(e=>e.startsWith("'")&&e.endsWith("'")?e.slice(1,-1).replace(/''/g,"'"):e),m=(0,t.joinSqlFragments)(_.map(e=>(0,t.literal)(e)),",");return t.safeSql`ARRAY[${m}]${s}`}(e);if(null!==a)return a}return(0,t.literal)(e)}function d(e){return t.safeSql`${(0,t.ident)(e.schema)}.${(0,t.ident)(e.name)}`}e.s(["countQuery",0,a,"deleteQuery",0,i,"insertQuery",0,r,"selectQuery",0,l,"truncateQuery",0,n,"updateQuery",0,s,"wrapWithRollback",0,function(e){return t.safeSql`
  ...
  `},"wrapWithTransaction",0,function(e){return t.safeSql`
    ...
    commit;
  `}],332357);class _{table;actionConfig;options;pagination;constructor(e,t,a){this.table=e,this.actionConfig=t,this.options=a}range(e,t){return this.pagination={offset:e,limit:t-e+1},this}toSql(e={isCTE:!1,isFinal:!0}){try{let{actionOptions:o,filters:c,sorts:d}=this.options??{};switch(this.actionConfig.action){case"count":return a(this.table,{filters:c});case"delete":return i(this.table,c,{returning:o?.returning,enumArrayColumns:o?.enumArrayColumns});case"insert":return r(this.table,this.actionConfig.actionValue,{returning:o?.returning,enumArrayColumns:o?.enumArrayColumns});case"select":return l(this.table,this.actionConfig.actionValue,{filters:c,pagination:this.pagination,sorts:d},e.isFinal,e.isCTE);case"update":return s(this.table,this.actionConfig.actionValue,{filters:c,returning:o?.returning,enumArrayColumns:o?.enumArrayColumns});case"truncate":return n(this.table,{cascade:o?.cascade});default:return t.safeSql``}}catch(e){throw e}}}e.s(["QueryModifier",0,_],29659);class m{table;actionConfig;actionOptions;filters;sorts;constructor(e,t,a){this.table=e,this.actionConfig=t,this.actionOptions=a,this.filters=[],this.sorts=[]}filter(e,t,a){return this.filters.push({column:e,operator:t,value:a}),this}match(e){return Object.entries(e).map(([e,t])=>{this.filters.push({column:e,operator:"=",value:t})}),this}order(e,t,a=!0,n=!1){return this.sorts.push({table:e,column:t,ascending:a,nullsFirst:n}),this}range(e,t){return this._getQueryModifier().range(e,t)}clone(){let e=structuredClone({table:this.table,actionConfig:this.actionConfig,actionOptions:this.actionOptions,filters:this.filters,sorts:this.sorts}),t=new m(e.table,e.actionConfig,e.actionOptions);return t.filters=e.filters,t.sorts=e.sorts,t}toSql(e){return this._getQueryModifier().toSql(e)}_getQueryModifier(){return new _(this.table,this.actionConfig,{actionOptions:this.actionOptions,filters:this.filters,sorts:this.sorts})}}e.s(["QueryFilter",0,m],193767);class p{table;constructor(e){this.table=e}count(){return new m(this.table,{action:"count"})}delete(e){return new m(this.table,{action:"delete"},e)}insert(e,t){return new m(this.table,{action:"insert",actionValue:e},t)}select(e){return new m(this.table,{action:"select",actionValue:e})}update(e,t){return new m(this.table,{action:"update",actionValue:e},t)}truncate(e){return new m(this.table,{action:"truncate"},e)}}e.s(["QueryAction",0,p],212695),e.s(["Query",0,class{from(e,t){return new p({name:e,schema:t??"public"})}}],721490)},850036,247309,387578,640696,517638,53336,957386,779262,538892,190804,788035,389273,e=>{"use strict";var t,a=e.i(976876),n=e.i(761087),i=e.i(486603),r=e.i(981263),l=e.i(254873),s=e.i(198687),o=e.i(673351),c=e.i(784883),d=e.i(201049),_=e.i(557928),m=e.i(567205),p=e.i(912920),u=e.i(454430),E=e.i(303119),f=e.i(819615),g=e.i(211309),S=e.i(267655),b=e.i(58347);e.i(967533);var N=e.i(721490),h=e.i(332357),T=e.i(193767),v=e.i(212695),A=e.i(29659);e.s(["Query",()=>N.Query,"QueryAction",()=>v.QueryAction,"QueryFilter",()=>T.QueryFilter,"QueryModifier",()=>A.QueryModifier,"countQuery",()=>h.countQuery,"deleteQuery",()=>h.deleteQuery,"insertQuery",()=>h.insertQuery,"selectQuery",()=>h.selectQuery,"truncateQuery",()=>h.truncateQuery,"updateQuery",()=>h.updateQuery,"wrapWithRollback",()=>h.wrapWithRollback,"wrapWithTransaction",()=>h.wrapWithTransaction],377171);var $=e.i(377171),I=e.i(479084);let q=I.safeSql`
...
END;
$$;
`;function R(e,t){let a="00000000-0000-0000-0000-000000000000".split("").map((t,a)=>"-"===t?t:e[a]??t);if(e.length>=a.length)return a.join("");if(e.length&&e.length<15&&(a[14]="4"),e.length&&e.length<20&&(a[19]=t?"b":"8"),t)for(let t=e.length;t<a.length;t+=1)"0"===a[t]&&(a[t]="f");return a.join("")}function L(e){if(!e)return[e,void 0];let t=e.charCodeAt(e.length-1);if(122===t)return[e,e+"~"];if(t>=126)return[e,e+" "];let a=e.substring(0,e.length-1)+String.fromCharCode(t+1);return[e,a]}e.s(["COUNT_ESTIMATE_SQL",0,q,"THRESHOLD_COUNT",0,5e4],247309),e.s(["prefixToUUID",0,R,"stringRange",0,L],387578);let y=I.safeSql`select reltuples as estimate from pg_class where oid = 'auth.users'::regclass`;e.s(["getUsersCountSQL",0,({filter:e,keywords:t,providers:a,forceExactCount:n=!1,column:i})=>{let r=t&&""!==t,l=[],s=I.safeSql`select count(*) from auth.users`,o=I.safeSql`select * from auth.users`;if(i&&r){if("email"===i){let e=L(t),a=(0,I.literal)(e[0]),n=e[1]?(0,I.literal)(e[1]):null;l.push(I.safeSql`lower(email) >= ${a}${n?I.safeSql` and lower(email) < ${n}`:I.safeSql``} and instance_id = '00000000-0000-0000-0000-000000000000'::uuid`)}else if("phone"===i){let e=L(t),a=(0,I.literal)(e[0]),n=e[1]?(0,I.literal)(e[1]):null;l.push(I.safeSql`phone >= ${a}${n?I.safeSql` and phone < ${n}`:I.safeSql``}`)}else if("id"===i){let e=R(t,!1);if(e===t)l.push(I.safeSql`id = ${(0,I.literal)(t)}`);else{let a=R(t,!0);l.push(I.safeSql`id >= ${(0,I.literal)(e)} and id < ${(0,I.literal)(a)}`)}}}else{if(r){let e=(0,I.literal)(`%${t}%`);l.push(I.safeSql`id::text ilike ${e} or email ilike ${e} or phone ilike ${e}`)}if("verified"===e?l.push(I.safeSql`email_confirmed_at IS NOT NULL or phone_confirmed_at IS NOT NULL`):"anonymous"===e?l.push(I.safeSql`is_anonymous is true`):"unverified"===e&&l.push(I.safeSql`email_confirmed_at IS NULL AND phone_confirmed_at IS NULL`),a&&a.length>0)if(a.includes("saml 2.0")){let e=a.map(e=>"saml 2.0"===e?"sso":e);l.push(I.safeSql`(select jsonb_agg(case when value ~ '^sso' then 'sso' else value end) from jsonb_array_elements_text((raw_app_meta_data ->> 'providers')::jsonb)) ?| array[${(0,I.literal)(e)}]`)}else l.push(I.safeSql`(raw_app_meta_data->>'providers')::jsonb ?| array[${(0,I.literal)(a)}]`)}let c=(0,I.joinSqlFragments)(l.map(e=>I.safeSql`(${e})`)," and "),d=l.length>0?I.safeSql` where ${c}`:I.safeSql``;if(n)return I.safeSql`select (${s}${d}), false as is_estimate;`;{let e=I.safeSql`${o}${d}`,t=I.safeSql`${s}${d}`,a=(0,I.literal)(e);return I.safeSql`${q}

with approximation as (${y})
select 
  case 
    when estimate = -1 then (select pg_temp.count_estimate(${a}))::int
    when estimate > ${(0,I.literal)(5e4)} then ${l.length>0?I.safeSql`(select pg_temp.count_estimate(${a}))::int`:I.safeSql`estimate::int`}
    else (${t})
  end as count,
  estimate = -1 or estimate > ${(0,I.literal)(5e4)} as is_estimate
from approximation`}}],640696);let O=I.safeSql`
SELECT id, name, file_size_limit
FROM storage.buckets
WHERE file_size_limit IS NOT NULL
ORDER BY file_size_limit DESC
LIMIT ${(0,I.literal)(51)};
`;e.s(["LARGEST_SIZE_LIMIT_BUCKETS_COUNT",0,50,"getLargestSizeLimitBucketsSqlUnoptimized",0,O],517638),e.s(["getDatabaseExtensionsSQL",0,()=>I.safeSql`
SELECT
  e.name,
  n.nspname AS schema,
  e.default_version,
...
`,"getEnableDatabaseExtensionSQL",0,({schema:e,name:t,version:a,cascade:n,createSchema:i=!1})=>{let{sql:l}=r.default.create({schema:e,name:t,version:a,cascade:n});return i?I.safeSql`CREATE SCHEMA IF NOT EXISTS ${(0,I.ident)(e)};
${l}`:l}],53336);let C=I.safeSql`pgmq_public`,F=I.safeSql`
  drop function if exists 
    ${C}.pop(queue_name text),
    ${C}.send(queue_name text, message jsonb, sleep_seconds integer),
    ${C}.send_batch(queue_name text, message jsonb[], sleep_seconds integer),
    ${C}.archive(queue_name text, message_id bigint),
    ${C}.delete(queue_name text, message_id bigint),
    ${C}.read(queue_name text, sleep integer, n integer)
  ;
...
`;e.s(["HIDE_QUEUES_FROM_POSTGREST_SQL",0,F,"QUEUES_SCHEMA",0,C,"getExposeQueuesSQL",0,({isNewerPgmqversion:e})=>{let t=e?I.safeSql`, conditional := '{}'::jsonb`:I.safeSql``,a=e?I.safeSql`, jsonb`:I.safeSql``;return I.safeSql`
  create schema if not exists ${C};
  grant usage on schema ${C} to postgres, anon, authenticated, service_role;

  create or replace function ${C}.pop(
      queue_name text
  )
  ...
  comment on function ${C}.pop(queue_name text) is 'Retrieves and locks the next message from the specified queue.';


  create or replace function ${C}.send(
      queue_name text,
      message jsonb,
  ...
  comment on function ${C}.send(queue_name text, message jsonb, sleep_seconds integer) is 'Sends a message to the specified queue, optionally delaying its availability by a number of seconds.';


  create or replace function ${C}.send_batch(
      queue_name text,
      messages jsonb[],
      sleep_seconds integer default 0  -- renamed from 'delay'
  )
  ...
  comment on function ${C}.send_batch(queue_name text, messages jsonb[], sleep_seconds integer) is 'Sends a batch of messages to the specified queue, optionally delaying their availability by a number of seconds.';


  create or replace function ${C}.archive(
      queue_name text,
      message_id bigint
  )
    returns boolean
  ...
  comment on function ${C}.archive(queue_name text, message_id bigint) is 'Archives a message by moving it from the queue to a permanent archive.';


  create or replace function ${C}.delete(
      queue_name text,
      message_id bigint
  )
    returns boolean
  ...
  comment on function ${C}.delete(queue_name text, message_id bigint) is 'Permanently deletes a message from the specified queue.';

  create or replace function ${C}.read(
      queue_name text,
  ...
  comment on function ${C}.read(queue_name text, sleep_seconds integer, n integer) is 'Reads up to "n" messages from the specified queue with an optional "sleep_seconds" (visibility timeout).';

  -- Grant execute permissions on wrapper functions to roles
  grant execute on function ${C}.pop(text) to postgres, service_role, anon, authenticated;
  grant execute on function pgmq.pop(text) to postgres, service_role, anon, authenticated;

  grant execute on function ${C}.send(text, jsonb, integer) to postgres, service_role, anon, authenticated;
  grant execute on function pgmq.send(text, jsonb, integer) to postgres, service_role, anon, authenticated;

  grant execute on function ${C}.send_batch(text, jsonb[], integer) to postgres, service_role, anon, authenticated;
  grant execute on function pgmq.send_batch(text, jsonb[], integer) to postgres, service_role, anon, authenticated;

  grant execute on function ${C}.archive(text, bigint) to postgres, service_role, anon, authenticated;
  grant execute on function pgmq.archive(text, bigint) to postgres, service_role, anon, authenticated;

  grant execute on function ${C}.delete(text, bigint) to postgres, service_role, anon, authenticated;
  grant execute on function pgmq.delete(text, bigint) to postgres, service_role, anon, authenticated;

  grant execute on function ${C}.read(text, integer, integer) to postgres, service_role, anon, authenticated;
  ...
  */
  ...
  on sequences
  to anon, authenticated, service_role;
`},"getQueuesExposePostgrestStatusSQL",0,()=>I.safeSql`
    SELECT exists (select schema_name FROM information_schema.schemata WHERE schema_name = '${C}');
  `],957386),e.s(["getTableRowsCountSql",0,({table:e,filters:t=[],enforceExactCount:a=!1,isUsingReadReplica:n=!1})=>{if(!e)return I.safeSql``;if(a){let a=new N.Query().from(e.name,e.schema??void 0).count();t.filter(e=>e.value&&""!==e.value).forEach(e=>{a=a.filter(e.column,e.operator,e.value)});let n=a.toSql(),i=n.endsWith(";")?n.slice(0,-1):n;return I.safeSql`select (${i}), false as is_estimate;`}{let a=new N.Query().from(e.name,e.schema??void 0).select();t.filter(e=>e.value&&""!=e.value).forEach(e=>{a=a.filter(e.column,e.operator,e.value)});let i=a.toSql(),r=i.endsWith(";")?i.slice(0,-1):i,l=new N.Query().from(e.name,e.schema??void 0).count();t.filter(e=>e.value&&""!=e.value).forEach(e=>{l=l.filter(e.column,e.operator,e.value)});let s=l.toSql(),o=s.endsWith(";")?s.slice(0,-1):s;return n?I.safeSql`
with approximation as (
    select reltuples as estimate
    from pg_class
    where oid = ${(0,I.literal)(e.id)}
)
select 
  case 
    when estimate > ${(0,I.literal)(5e4)} then (select -1)
    else (${o})
  end as count,
  estimate > ${(0,I.literal)(5e4)} as is_estimate
from approximation;
`:I.safeSql`
${q}
...
select 
  case 
    when estimate > ${(0,I.literal)(5e4)} then ${t.length>0?I.safeSql`pg_temp.count_estimate('${r.replaceAll("'","''")}')`:I.safeSql`estimate`}
    else (${o})
  end as count,
  estimate > ${(0,I.literal)(5e4)} as is_estimate
from approximation;
`}}],779262);let D=I.safeSql`
  ...
  $$
    ...
    END;
  $$;`;e.s(["getEntityDefinitionsSql",0,({schemas:e,limit:t=100})=>I.safeSql`
${D}
...
with records as (
  ...
  where
    ...
    and nc.nspname IN (${(0,I.joinSqlFragments)(e.map(e=>(0,I.literal)(e)),", ")})
...
from records r;
  `,"getTableDefinitionSql",0,({id:e})=>I.safeSql`
    ${D}
    ...
    from table_info t;
  `],538892);var z=e.i(248593),w=e.i(643135),x=e.i(9172);e.s(["getTablesPaginatedSql",0,({schema:e,includeColumns:t=!1,limit:a,afterOid:n,nameFilter:i})=>{let r=(0,w.filterByList)(e?[e]:void 0,void 0,e?void 0:z.DEFAULT_SYSTEM_SCHEMAS),l=r?I.safeSql`and nc.nspname ${r}`:I.safeSql``,s=i&&i.length>0?I.safeSql`and c.relname ilike ${(0,I.literal)(`%${i.replace(/([\\%_])/g,"\\$1")}%`)}`:I.safeSql``,o=t?I.safeSql`, columns as (${(0,x.getColumnsSql)({filter:{column:"oid",predicate:I.safeSql`in (select oid from page)`}})})`:I.safeSql``,c=t?I.safeSql`, ${(0,w.coalesceRowsToArray)("columns",I.safeSql`columns.table_id = tables.id`)}`:I.safeSql``;return I.safeSql`
    with page as (
      select
        c.oid,
        c.relname,
    ...
    from tables
    order by tables.id
  `}],190804);var U=((t={}).NO_ACTION="a",t.RESTRICT="r",t.CASCADE="c",t.SET_NULL="n",t.SET_DEFAULT="d",t);e.s(["FOREIGN_KEY_CASCADE_ACTION",()=>U,"getAddForeignKeySQL",0,({table:e,foreignKeys:t})=>{let a=t.map(t=>{let{deletionAction:a,updateAction:n}=t,i="c"===a?I.safeSql`ON DELETE CASCADE`:"r"===a?I.safeSql`ON DELETE RESTRICT`:"d"===a?I.safeSql`ON DELETE SET DEFAULT`:"n"===a?I.safeSql`ON DELETE SET NULL`:I.safeSql``,r="c"===n?I.safeSql`ON UPDATE CASCADE`:"r"===n?I.safeSql`ON UPDATE RESTRICT`:I.safeSql``,l=(0,I.joinSqlFragments)(t.columns.map(e=>(0,I.ident)(e.source)),", "),s=(0,I.joinSqlFragments)(t.columns.map(e=>(0,I.ident)(e.target)),", ");return I.safeSql`ALTER TABLE ${(0,I.ident)(e.schema)}.${(0,I.ident)(e.name)} ADD FOREIGN KEY (${l}) REFERENCES ${(0,I.ident)(t.schema)}.${(0,I.ident)(t.table)} (${s}) ${r} ${i}`});return I.safeSql`${(0,I.joinSqlFragments)(a,";\n")};`},"getForeignKeyConstraintsSql",0,({schema:e})=>{if(!e)throw Error("schema is required");return I.safeSql`
SELECT
  con.oid as id,
...
WHERE
  con.contype = 'f'
  AND nsp.nspname = ${(0,I.literal)(e)}
`},"getRemoveForeignKeySQL",0,({table:e,foreignKeys:t})=>{let a=t.map(t=>I.safeSql`ALTER TABLE IF EXISTS ${(0,I.ident)(e.schema)}.${(0,I.ident)(e.name)} DROP CONSTRAINT IF EXISTS ${(0,I.ident)(t.name)}`);return I.safeSql`${(0,I.joinSqlFragments)(a,";\n")};`}],788035);let H=I.safeSql`ROLE_IMPERSONATION_NO_RESULTS`;e.s(["ROLE_IMPERSONATION_NO_RESULTS",0,H,"ROLE_IMPERSONATION_SQL_LINE_COUNT",0,11,"getImpersonationSQL",0,({role:e,unexpiredClaims:t,sql:a})=>{var n;let i="postgrest"===e.type?void 0!==t?function({role:e,unexpiredClaims:t}){return I.safeSql`
select set_config('role', ${(0,I.literal)(e)}, true),
set_config('request.jwt.claims', ${(0,I.literal)(JSON.stringify(t))}, true),
...
set_config('request.headers', '{"accept": "*/*"}', true);
  `}({role:e.role,unexpiredClaims:t}):I.safeSql``:(n=e.role,I.safeSql`
    set local role ${(0,I.literal)(n)};
  `);return I.safeSql`
    ${i}
    ...
    ${a}
  `}],389273);let k={roles:m.default,columns:n.default,schemas:p.default,tables:E,functions:s,tablePrivileges:u.default,publications:_.default,extensions:r.default,config:i.default,materializedViews:c.default,foreignTables:l.default,views:b.default,policies:d.default,triggers:f.default,types:g.default,version:S.default,indexes:o.default,columnPrivileges:a.default,query:$};e.s(["default",0,k],850036)}]);

//# debugId=66eb5463-a4a7-e870-6478-f259dd7fede8
//# sourceMappingURL=0dv0kl687jbhd.js.map